...
<div class="login-wrapper">
    ...
    <div class="login-card">
        ...
        <form action="<?= BASE_APP ?>/home" method="POST"> <div class="mb-3">
                <label class="form-label small fw-bold text-muted">ID Pegawai (NIK)</label>
                <input type="text" class="form-control form-control-custom" placeholder="Masukkan ID Pegawai" required>
            </div>
            
            <div class="mb-4">
                <label class="form-label small fw-bold text-muted">Password</label>
                <input type="password" class="form-control form-control-custom" placeholder="Masukkan Password" required>
            </div>
