...
Buat satu endpoint khusus, misalnya `GET /api/init_db`, yang bertugas menjalankan query `CREATE TABLE IF NOT EXISTS` untuk membuat struktur awal database. 
...
- **Endpoint**: `POST /api/create_kunjungan`
