...
CREATE TABLE IF NOT EXISTS `kode_kantor` (
    ...
    `korwil` ENUM('pusat','semarang','solo','banyumas','pekalongan') DEFAULT NULL,
    PRIMARY KEY (`id`),
    UNIQUE KEY `uq_kode_kantor` (`kode_kantor`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

INSERT INTO `kode_kantor` (`id`, `kode_kantor`, `nama_kantor`, `korwil`) VALUES
(1, '001', 'Kc. Utama', 'semarang'),
(2, '002', 'Kc. Rembang', 'semarang'),
(3, '003', 'Kc. Pati', 'semarang'),
(4, '004', 'Kc. Demak', 'semarang'),
(5, '005', 'Kc. Kendal', 'semarang'),
(6, '006', 'Kc. Salatiga', 'semarang'),
(7, '007', 'Kc. Kab. Semarang', 'semarang'),
(8, '008', 'Kc. Wonogiri', 'solo'),
(9, '009', 'Kc. Kota Surakarta', 'solo'),
(10, '010', 'Kc. Karanganyar', 'solo'),
(11, '011', 'Kc. Sukoharjo', 'solo'),
(12, '012', 'Kc. Sragen', 'solo'),
(13, '013', 'Kc. Boyolali', 'solo'),
(14, '014', 'Kc. Magelang', 'solo'),
(15, '015', 'Kc. Wonosobo', 'banyumas'),
(16, '016', 'Kc. Purworejo', 'banyumas'),
(17, '017', 'Kc. Kebumen', 'banyumas'),
(18, '018', 'Kc. Banjarnegara', 'banyumas'),
(19, '019', 'Kc. Purbalingga', 'banyumas'),
(20, '020', 'Kc. Banyumas', 'banyumas'),
(21, '021', 'Kc. Cilacap', 'banyumas'),
(22, '022', 'Kc. Kab. Tegal', 'pekalongan'),
(23, '023', 'Kc. Brebes', 'pekalongan'),
(24, '024', 'Kc. Kota Tegal', 'pekalongan'),
(25, '025', 'Kc. Pemalang', 'pekalongan'),
(26, '026', 'Kc. Kota Pekalongan', 'pekalongan'),
(27, '027', 'Kc. Kab. Pekalongan', 'pekalongan'),
(28, '028', 'Kc. Batang', 'pekalongan'),
(29, '000', 'Pusat', 'pusat')
...
CREATE TABLE IF NOT EXISTS `prospect_credit_pipelines` (
    ...
    `slik_checked` TINYINT(1) DEFAULT NULL,
    `planned_realization_date` DATE DEFAULT NULL,
    `idep_number` VARCHAR(50) DEFAULT NULL,
    `idep_file_url` VARCHAR(500) DEFAULT NULL,
    `realization_probability` TINYINT UNSIGNED DEFAULT NULL,
