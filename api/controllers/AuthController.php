...
class AuthController
{
    ...
    {
        // # FLOW: Dummy hanya boleh dipakai jika diaktifkan eksplisit pada environment development.
    ...
    public static function buildSessionUser(string $token, ?array $ssoUser = null): ?array
    {
        ...
        $profile = [
            ...
            'kode_unit_kerja' => $ssoUser['kode_unit_kerja'] ?? $ssoUser['kode_unit'] ?? $local['kode_unit_kerja'] ?? '',
    ...
    public function whoami(): void
    {
        ...
        sendResponse(200, 'OK', [
            ...
            'kode_unit_kerja' => $sessionUser['kode_unit_kerja'],
